...
"""Verify that starting litreen with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litreen with -h for help text")
        ...
        self.log.info("Start litreen with -version for version information")
        ...
        self.log.info("Start litreend with -fakearg to make sure it does not start")
