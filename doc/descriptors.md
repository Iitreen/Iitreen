# Support for Output Descriptors in Litreen Core

Since Litreen Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `ltrn1...` for mainnet or `tltrn1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Litreen Core wallets, a convenience function `combo` is
