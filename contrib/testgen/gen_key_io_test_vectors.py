...
bech32_templates = [
  ...
  ('ltrn',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ltrn',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ltrn',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('ltrn',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tltrn',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tltrn',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tltrn',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tltrn',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tltrn',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tltrn',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tltrn',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tltrn',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rltrn',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rltrn',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rltrn',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rltrn', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tltrn',   17, 32, Encoding.BECH32M, False, False, False),
  ('rltrn',  3,  1, Encoding.BECH32M, False, False, False),
  ('ltrn',   15, 41, Encoding.BECH32M, False, False, False),
  ('tltrn',    0, 16, Encoding.BECH32,  False, False, False),
  ('rltrn',  0, 32, Encoding.BECH32,  True,  False, False),
  ('ltrn',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tltrn',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rltrn',  0, 20, Encoding.BECH32,  False, False, True),
  ('ltrn',    0, 20, Encoding.BECH32M, False, False, False),
  ('tltrn',    0, 32, Encoding.BECH32M, False, False, False),
  ('rltrn',  0, 20, Encoding.BECH32M, False, False, False),
  ('ltrn',    1, 32, Encoding.BECH32,  False, False, False),
  ('tltrn',    2, 16, Encoding.BECH32,  False, False, False),
  ('rltrn', 16, 20, Encoding.BECH32,  False, False, False),
]
