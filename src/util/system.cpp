...
const char * const BITCOIN_CONF_FILENAME = "litreen.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Litreen";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Litreen";
#else
    // Unix-like
    return pathRet / ".litreen";
#endif
#endif
}
