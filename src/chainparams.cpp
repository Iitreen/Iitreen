...
{
    const char* pszTimestamp = "Elon Reeve Musk is een Zuid Afrikaans Canadees Amerikaans ondernemer";
    const CScript genesisOutputScript = CScript() << ParseHex("04a2a0d83c357aebec132c0a8c2ae77c99b6abc767c3c3f80f1f490689c27837bb65101afc64f9379b6c34af58d306ec9b66ef97d7b5e4bd3b4be774a8e1198df4") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0xf2a3c0aca103be93add36405bcbb8771f5870d15e9448949d3c89e90fc240f3a"); 
        ...
        genesis = CreateGenesisBlock(1710305967, 2408510, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf2a3c0aca103be93add36405bcbb8771f5870d15e9448949d3c89e90fc240f3a"));
        assert(genesis.hashMerkleRoot == uint256S("0x1690f357e0bb34cc7803c897ec2c1319e0369f2c93d950fed74f826de89fa9f6"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0xf2a3c0aca103be93add36405bcbb8771f5870d15e9448949d3c89e90fc240f3a")},
            }
        };

        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 4096 f2a3c0aca103be93add36405bcbb8771f5870d15e9448949d3c89e90fc240f3a
            /* nTime    */ 1710305967,
            /* nTxCount */ 0,
            /* dTxRate  */ 0
        };
...
public:
    CTestNetParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0xb5a05f9a1b505b5dcdf6e9662e9905370c5ec93da244b1b1fd3c9e354b80eb0d"); 
        ...
        genesis = CreateGenesisBlock(1710306501, 1242937, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb5a05f9a1b505b5dcdf6e9662e9905370c5ec93da244b1b1fd3c9e354b80eb0d"));
        assert(genesis.hashMerkleRoot == uint256S("0x1690f357e0bb34cc7803c897ec2c1319e0369f2c93d950fed74f826de89fa9f6"));
        ...
        checkpointData = {
            {
                {0, uint256S("b5a05f9a1b505b5dcdf6e9662e9905370c5ec93da244b1b1fd3c9e354b80eb0d")},
            }
        };

        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 b5a05f9a1b505b5dcdf6e9662e9905370c5ec93da244b1b1fd3c9e354b80eb0d
            /* nTime    */ 1710306501,
            /* nTxCount */ 0,
            /* dTxRate  */ 0,
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1710306779, 3, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4fc00381338676a42be61ff4ffd1303d79f29710b781f2029bbdca7066f0d66f"));
        assert(genesis.hashMerkleRoot == uint256S("0x1690f357e0bb34cc7803c897ec2c1319e0369f2c93d950fed74f826de89fa9f6"));
        ...
        checkpointData = {
            {
                {0, uint256S("4fc00381338676a42be61ff4ffd1303d79f29710b781f2029bbdca7066f0d66f")},
            }
        };
