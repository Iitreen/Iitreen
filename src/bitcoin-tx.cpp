...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " litreen-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  litreen-tx [options] <hex-tx> [commands]  Update hex-encoded litreen transaction\n" +
            "or:     litreen-tx [options] -create [commands]   Create hex-encoded litreen transaction\n" +
            "\n";
