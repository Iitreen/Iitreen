Contributing to Litreen Core
============================

The Litreen Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Litreen Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/litreen-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to litreen-qt
...
The following applies to code changes to the Litreen Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Litreen
Network Protocol consensus changes.

Whether a pull request is merged into Litreen Core rests with the project merge
...
Patches that change Litreen consensus rules are considerably more involved than
...
Where a patch set proposes to change the Litreen consensus, it must have been
...
The project leader is the release manager for each Litreen Core release.
